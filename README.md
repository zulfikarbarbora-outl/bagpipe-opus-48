...
Opus 48 kbps preview MP3s for the **bagpipe** sample library.
...
- **Files**: 26 Opus previews
- **Bitrate**: 48 kbps VBR
- **Container**: Ogg Opus (.opus)
- **Source**: [`zulfikarbarbora-outl/bagpipe`](https://github.com/zulfikarbarbora-outl/bagpipe)
- **Branch**: `main`

## URL pattern

```
https://raw.githubusercontent.com/zulfikarbarbora-outl/bagpipe-opus-48/main/<filename>.opus
```
